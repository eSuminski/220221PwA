...
"""
This module implements the Team data access object interface. These methods ONLY interact with the database, they do
not validate the information being passed into them, since that is handled by the Service layer. The only checks 
